    ...
    return {
      ...
      option: {
        ...
        column: [
          ...
          { label: '平台商品编码', prop: 'platformProductId', search: true, rules: [{ required: true, message: '平台商品编码不能为空', trigger: 'blur' }] },
          { label: '平台销售sku', prop: 'platformSku', search: true, rules: [{ required: true, message: '平台销售sku不能为空', trigger: 'blur' }] },
          { label: 'sku', prop: 'sku', rules: [{ required: true, message: 'sku不能为空', trigger: 'blur' }] },
