    ...
    return {
      ...
      option: {
        ...
        column: [
          ...
          { label: '平台代码', prop: 'platformCode', search: true, type: 'select', dicData: platformList },
          ...
          { label: '取消订单状态:', prop: 'cancelOmsOrderStatus', search: true, dataType: 'number', rules: [{ required: true, message: '取消oms订单状态:0-默认,1-取消成功,2-取消失败不能为空', trigger: 'blur' }], type: 'select', dicData: [{ value: 0, label: '默认' }, { value: 1, label: '取消成功' }, { value: 2, label: '取消失败' }] },
          { label: '取消订单时间', prop: 'cancelOmsOrderTime', rules: [{ required: true, message: '取消oms订单时间不能为空', trigger: 'blur' }] },
          { label: '取消订单请求', prop: 'cancelOmsOrderRequest', hide: true, rules: [{ required: true, message: '取消oms订单请求不能为空', trigger: 'blur' }] },
          { label: '取消订单响应', prop: 'cancelOmsOrderResponse', hide: true, rules: [{ required: true, message: '取消oms订单响应不能为空', trigger: 'blur' }] },
