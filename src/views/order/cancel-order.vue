    ...
    return {
      ...
      option: {
        ...
        column: [
          ...
          { label: 'ueb订单号', prop: 'orderNo', search: true, rules: [{ required: true, message: 'ueb订单号不能为空', trigger: 'blur' }] },
          ...
          { label: '取消oms订单状态:', prop: 'cancelOmsOrderStatus', dataType: 'number', rules: [{ required: true, message: '取消oms订单状态:0-默认,1-取消成功,2-取消失败不能为空', trigger: 'blur' }], type: 'select', dicData: [{ value: 0, label: '默认' }, { value: 1, label: '取消成功' }, { value: 2, label: '取消失败' }] },
