    ...
    return {
      ...
      option: {
        ...
        column: [
          ...
          { label: '分隔任务周期', prop: 'productSplitDate', type: 'select', valueDefault: '', dicData: [{ value: '', label: '系统默认' }, { value: '60', label: '一小时' }, { value: '360', label: '六小时' }, { value: '720', label: '半天' }, { value: '1440', label: '一天' }] },
