    ...
    return {
      ...
      option: {
        ...
        column: [
          ...
          { label: '分隔任务周期', prop: 'productSplitDate', type: 'select', valueDefault: '1440', dicData: [{ value: '60', label: '一小时' }, { value: '360', label: '六小时' }, { value: '720', label: '12小时' }, { value: '1440', label: '1天' }, { value: '43200', label: '30天' }, { value: '', label: '系统默认' }, { value: '1', label: '1分钟' }, { value: '5', label: '5分钟' }, { value: '30', label: '30分钟' }] },
