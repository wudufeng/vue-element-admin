  ...
  data() {
    return {
      ...
      option: {
        ...
        indexLabel: '序号',
        column: [
          { label: '主键', prop: 'id', search: true, addDisplay: false, editDisplay: false, addDisabled: true, editDisabled: true, hide: true, showColumn: false, rules: [{ required: true, message: '主键不能为空', trigger: 'blur' }] },
          ...
          { label: '级联类型', prop: 'cascadeType', editDisabled: true, search: true, rules: [{ required: true, message: '级联类型不能为空', trigger: 'blur' }], type: 'select', value: 1, dicData: [{ value: 1, label: '不限制' }, { value: 2, label: '账号' }, { value: 3, label: '部门' }, { value: 4, label: '平台商品编码' }] },
