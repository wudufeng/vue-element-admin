    ...
    return {
      ...
      option: {
        ...
        column: [
          ...
          { label: '国家/站点', prop: 'site', rules: [{ required: true, message: '国家/站点不能为空', trigger: 'blur' }] },
          ...
          { label: '登录邮箱', prop: 'email', hide: true, rules: [{ required: true, message: '登录邮箱不能为空', trigger: 'blur' }] },
